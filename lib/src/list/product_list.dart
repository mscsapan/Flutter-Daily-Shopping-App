...
List<Product> products = [
  ...
  Product(
      image: 'assets/vegetable/broccoli.png',
  ...
  Product(
      category: categories[2],
      image: 'assets/vegetable/potato.png',
      description:
  ...
  Product(
      category: categories[2],
      image: 'assets/vegetable/celery.png',
      name: 'Celery',
      description:
  ...
  Product(
      category: categories[2],
      image: 'assets/vegetable/lettuce.png',
